 ...
 * $Id: score_mat.c,v 1.10 2014/07/05 14:37:17 torda Exp $
 */
 ...
 * removes an alignment from a scoringmatrix based on the according scoring matrix.
 * By this you are able to find the next lower best (subbest) alignment and so on ...
 *
 */
