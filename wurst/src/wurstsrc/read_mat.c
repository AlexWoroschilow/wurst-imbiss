 ...
 *
 * $Id: read_mat.c,v 1.2 2008/06/27 08:58:07 schenk Exp $
 */
...
sub_mat_get_by_c (struct sub_mat *s, const char ndx1, const char ndx2)
{
    ...
    return s->data[(unsigned char)std2thomas_char (ndx1)]
        [(unsigned char)std2thomas_char (ndx2)];
}
...
sub_mat_set_by_c (struct sub_mat *s, const char ndx1, const char ndx2, float f)
{
    ...
    s->data[(unsigned char)std2thomas_char (ndx1)]
        [(unsigned char)std2thomas_char (ndx2)] = f;
    s->data[(unsigned char)std2thomas_char (ndx2)]
        [(unsigned char)std2thomas_char (ndx1)] = f;
    return EXIT_SUCCESS;
}
