 ...
 * $Id: read_ac_strct.c,v 1.7 2014/11/27 13:25:28 bondarenko Exp $
 */
                     ...
                     const struct aa_strct_clssfcn *cmodel, const int norm)
{
    ...
    if (debug_n) {
        ...
        err_printf (this_sub, "Coord structure : %s \n", coord_name(structure) );
    }
    if (!structure) {
        err_printf (this_sub, "No Structure Input of input : %s \n", coord_name(structure) );
        return NULL;
    }
